...
export const translations = {
  fr: {
    ...
    invoice: {
      ...
      practitionerSubtitle: "Ostéopathe D.O. de l'Eliana",
      dateOfIssue: "Date d'émission",
      recipient: "Destinataire (Patient)",
      recipientDesc: "Généré pour transmission à la mutuelle de santé pour remboursement des honoraires.",
      tableDescription: "Description des prestations cliniques",
      tableTva: "TVA",
      tableUnitAmount: "Montant Unitaire",
      tableExempt: "0% (Exonéré)",
      totalHt: "Total HT",
      tvaLabel: "TVA (0%)",
      totalTtc: "Total Honoraires TTC",
      signatureStamp: "Signature & Cachet",
      signatureName: "Vincent Durroux, Ostéopathe D.O.",
      receiptDeclaration: "Reçu valant facture acquittée le {date} par {paymentMethod}.",
      approvedAssociation: "Membre d'une association agréée, le règlement par chèque ou carte bancaire est accepté.",
      methods: {
        card: "carte bancaire",
        cash: "espèces",
        transfer: "virement bancaire"
  ...
  en: {
    ...
    invoice: {
      ...
      closeButton: "Close",
      practitionerTitle: "Vincent Durroux",
      practitionerSubtitle: "Osteopath D.O. of l'Eliana",
      dateOfIssue: "Date of issue",
      recipient: "Recipient (Patient)",
      recipientDesc: "Generated for transmission to the health insurance company for reimbursement of fees.",
      tableDescription: "Description of clinical services",
      tableTva: "VAT",
      tableUnitAmount: "Unit Amount",
      tableExempt: "0% (Exempt)",
      totalHt: "Total excl. VAT",
      tvaLabel: "VAT (0%)",
      totalTtc: "Total Fees incl. VAT",
      signatureStamp: "Signature & Stamp",
      signatureName: "Vincent Durroux, Osteopath D.O.",
      receiptDeclaration: "Receipt valid as invoice paid on {date} by {paymentMethod}.",
      approvedAssociation: "Member of an approved association, payment by check or credit card is accepted.",
      methods: {
        card: "credit card",
        cash: "cash",
        transfer: "bank transfer"
  ...
  es: {
    ...
    invoice: {
      ...
      closeButton: "Cerrar",
      practitionerTitle: "Vincent Durroux",
      practitionerSubtitle: "Osteópata D.O. de l'Eliana",
      dateOfIssue: "Fecha de emisión",
      recipient: "Destinatario (Paciente)",
      recipientDesc: "Generado para su presentación al seguro médico para el reembolso de honorarios.",
      tableDescription: "Descripción de los servicios clínicos",
      tableTva: "IVA",
      tableUnitAmount: "Importe Unitario",
      tableExempt: "0% (Exento)",
      totalHt: "Total base imponible",
      tvaLabel: "IVA (0%)",
      totalTtc: "Total Honorarios con IVA",
      signatureStamp: "Firma y Sello",
      signatureName: "Vincent Durroux, Osteópata D.O.",
      receiptDeclaration: "Recibo de factura pagado el {date} mediante {paymentMethod}.",
      approvedAssociation: "Miembro de una asociación autorizada, se acepta el pago con cheque o tarjeta de crédito.",
      methods: {
        card: "tarjeta de crédito",
        cash: "efectivo",
        transfer: "transferencia bancaria"
